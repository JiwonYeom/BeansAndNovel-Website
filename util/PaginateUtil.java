...
public class PaginateUtil {
	...
	public static String getBookListPaginate(int pageNo,
            int total,
            int numPage,
            int numBlock,
            String url,
		...
		//이전버튼 비활성화
		paginate.append("<span class=\"prev\" title=\"이전 페이지 없음\"><i class=\"fa fa-chevron-left\"></i><span class=\"screen_out\">이전</span></span>");
		System.out.println("이전버튼 비활성화 : "+"<span class=\"prev\" title=\"이전 페이지 없음\"><i class=\"fa fa-chevron-left\"></i><span class=\"screen_out\">이전</span></span>");
		...
		System.out.println("이전버튼 활성화 : "+"<a class=\"prev\" href=\""+url+"?"+param+"="+(pageNo-1)+"\" title=\"이전 페이지로\"><i class=\"fa fa-chevron-left\"></i><span class=\"screen_out\">이전</span></a>");
		}
		...
		if(pageNo==printNum) {
			...
			//현재페이지
			paginate.append("<span class=\"now\" title=\"현재 "+pageNo+"페이지\">"+pageNo+"</span>");
			/*System.out.println("현재 페이지 "+"<strong class=\"now\" title=\"현재 "+pageNo+"페이지\">"+pageNo+"</strong>");*/
		}else {
			
			paginate.append("<a href=\""+url+"?"+param+"="+printNum+"\" title=\""+printNum+"\">"+printNum+"</a>");
			
			
			/*System.out.println("다른 페이지 "+"<a href=\""+url+"?"+param+"="+printNum+"\" title=\""+printNum+"\">"+printNum+"</a>");*/
		}
		...
		/*System.out.println("다음페이지버튼 : "+"<a class=\"next\" href=\""+url+"?"+param+"="+(pageNo+1)+"\" title=\"다음 페이지로\"><i class=\"fa fa-chevron-right\"></i><span class=\"screen_out\">다음</span></a>");*/
		}
